  ...
  return (
    <input
      ...
      className={cn(
        ...
        type === "date" &&
          "relative block pr-10 [&::-webkit-calendar-picker-indicator]:absolute [&::-webkit-calendar-picker-indicator]:right-3 [&::-webkit-calendar-picker-indicator]:cursor-pointer",
        className,
      )}
      {...props}
    />
