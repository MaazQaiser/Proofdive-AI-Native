...
export function PlatformUsageChart({ data }: Props) {
  return (
    <Card>
      <CardBody>
        <h2 className="text-base font-bold tracking-tight text-black">Platform Usage Trends</h2>
        <p className="mt-0.5 text-sm text-[var(--app-muted)]">Usage trends for core platform activities</p>
        <div className="mt-4">
          {data.length === 0 ? (
