...
export function PartnersListScreen() {
  const { partners, addPartner, updatePartner, existingEmails, existingReferralCodes } = usePartners();
  ...
  function handleCreatePartner(partner: Partner) {
    addPartner(partner);
  ...
  return (
    <div className="-m-6 flex h-full flex-col overflow-hidden">
      ...
      <AddPartnerDialog
        ...
        existingReferralCodes={existingReferralCodes}
