...
/**
 * REVIEW SNAPSHOT — the interview report exactly as it was on `main` before
 * the content, copy and bug-fix pass, byte-for-byte apart from this comment
 * and the component name. Kept so the original, the updated report and the
 * redesigned version can be compared side by side. Not linked from anywhere
 * but the updated report's toolbar; delete this folder once the review is done.
 */
export function ReportDetailScreenOriginal({ reportId }: Props) {
